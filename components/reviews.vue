        ...
        <div
            ...
            <div class="lg:col-span-4">
                ...
                <div class="mt-10">
                    ...
                    <a class="mt-6 inline-flex w-full items-center justify-center rounded-md border border-gray-300 bg-white py-2 px-8 text-sm font-medium text-gray-900 hover:bg-gray-50 sm:w-auto lg:w-full"
                       href="#">Write
                        a review</a>
                </div>
            </div>
                ...
                <div class="flow-root">
                    <div class="-my-12 divide-y divide-gray-200">
                        <div v-for="review in reviews.featured" :key="review.id" class="py-12">
                            <div class="flex items-center">
                                <img :alt="`${review.author}.`" :src="review.avatarSrc" class="h-12 w-12 rounded-full"/>
                                <div class="ml-4">
