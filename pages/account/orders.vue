                        ...
                        <div class="sm:col-span-12 md:col-span-7">
                            ...
                            <div class="mt-6">
                                <div class="overflow-hidden rounded-full bg-gray-200">
                                    <div :style="{ width: `calc((${product.step} * 2 + 1) / 8 * 100%)` }"
                                         class="h-2 rounded-full bg-indigo-600"/>
                                </div>
                                <div class="mt-6 hidden grid-cols-4 font-medium text-gray-600 sm:grid">
                                    <div class="text-indigo-600">Order placed</div>
                                    <div :class="[product.step > 0 ? 'text-indigo-600' : '', 'text-center']">
                                        Processing
                                    </div>
                                    <div :class="[product.step > 1 ? 'text-indigo-600' : '', 'text-center']">Shipped
                                    </div>
                                    <div :class="[product.step > 2 ? 'text-indigo-600' : '', 'text-right']">Delivered
                                    </div>
                                </div>
                            </div>
                        </div>
